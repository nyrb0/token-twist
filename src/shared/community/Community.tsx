            ...
            <div className={`${styles.wrapper} container`}>
                ...
                <div className={styles.blocks}>
                    <SocialBlock
                        title={'Threads'}
                        icon={'threads'}
                        strong="Все инсайды TokenTwist — в одном месте."
                        descs={[
                            'Удобные длинные посты с форматированием!',
                            'Чистые обсуждения без спама и флуда',
                            'Уведомления на важные апдейты',
                            'Органический рост без теней и просадок',
                        ]}
                        href=""
                    />
                    <SocialBlock
