...
const reviewss: IReviews[] = [
    ...
    },
    {
        id: '2fvs',
        username: 'degen69',
        text: 'Не финансовый совет, но я залетел all-in, и пока не жалею.Купил токен — и сразу почувствовал, что вселенная улыбается мне сквозь график.',
        procent: 864,
    },
    {
        id: 'ksdsfhjh',
